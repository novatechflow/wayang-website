...
2. **Own the code. Understand what you submit** If you cannot explain why the code works, do not submit it. You are accountable for bugs, security issues, and license violations in your contribution.
...
5. **Use different tools for test generation**. Avoid using the same tool you used for adding functionality with adding test units. This potentially avoids cases where the code generated is just to make the test pass.
